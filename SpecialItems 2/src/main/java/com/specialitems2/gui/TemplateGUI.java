...
public final class TemplateGUI {
    ...
    public static final String TITLE = ChatColor.LIGHT_PURPLE + "SpecialItems2";
    ...
    public static void open(Player p, int page) {
        ...
        Keys keys = new Keys(SpecialItems2Plugin.getInstance());
        ...
        for (int rIndex = start; rIndex < end; rIndex++) {
            ...
            for (TemplateItems.TemplateItem t : items) {
                ...
                ItemStack display = GuiItemUtil.forDisplay(SpecialItems2Plugin.getInstance(), t.stack());
